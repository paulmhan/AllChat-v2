                        ...
                        <Grid.Row>
                            <Grid.Column width={8} id="message">
                                ...
                                <Grid.Row>
                                    ...
                                    <Message.Header compact="true"> <p id="message-text"><small>{this.props.message.firstName}&nbsp;{this.props.message.lastName}:&nbsp;{this.props.message.text}</small></p></Message.Header>
