export default
    {
        ...
        translation: {
            ...
            de: "Siehe Übersetzung",
            hi: "अनुवाद देखें",
            it: "guarda la traduzione",
            ja: "翻訳を参照してください",
            ko: "번역 참조",
            ru: "Посмотреть перевод",
            tl: "Tingnan ang Pagsasalin",
            te: "అనువాదం చూడండి",
            vi: "xem phiên dịch"
        },
        delete: {
        ...
        contactfeed: {
            ...
            es: "Por favor ingrese sus comentarios ...",
            zh: "请输入您的反馈...",
            ar: "يرجى إدخال ملاحظاتك ...",
            fr: "Veuillez entrer vos commentaires ...",
            de: "Bitte geben Sie Ihr Feedback ein ...",
            hi: "कृपया अपनी प्रतिक्रिया दर्ज करें ...",
            it: "Inserisci il tuo feedback ...",
            ja: "フィードバックを入力してください...",
            ko: "의견을 입력하십시오 ...",
            ru: "Пожалуйста, введите свой отзыв ...",
            tl: "Mangyaring ipasok ang iyong puna ...",
            te: "దయచేసి మీ అభిప్రాయాన్ని నమోదు చేయండి ...",
            vi: "Vui lòng nhập phản hồi của bạn ..."
        },
        validateemail: {
