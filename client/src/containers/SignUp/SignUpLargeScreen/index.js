                ...
                <Grid.Column width={8}>
                    <Form id="signup-form-container-largescreen" size='large' onSubmit={handleSubmit(this.onSubmit)}>
                        <Segment id="signup-form-largescreen" stacked>
                            ...
                            <Header id="signup-form-directions-largescreen" as="h4">Please fill out the following information:</Header>
                            <Field
                                name='firstName'
                            ...
                            <br />
                            <Button
                                id="signup-btn-largescreen"
                                fluid
                                size='large'
                                type='submit'
                                disabled={invalid || submitting || submitFailed}
                            >
                                <div id="signup-btn-text-largescreen">Sign Up</div>
                            </Button>
                        </Segment>
                    </Form>
                </Grid.Column>
